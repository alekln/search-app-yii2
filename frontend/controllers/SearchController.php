...
use common\models\search\EmployeeQuery;
...
class SearchController extends Controller
{
    ...
    public function actionUsers()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            $dataProvider = $searchModel->search($model->getAttributes(),  $pagination = []);

        }

        return $this->render('index', ['model'=>$model, 'dataProvider'=>['users'=>$dataProvider]]);
    }
